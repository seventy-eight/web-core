...
public class FeatureSearch {
    ...
    private static final File mapFile = new File( FeatureSearch.class.getResource( "search.resources.map.js" ).getFile() );
    private static final File reduceFile = new File( FeatureSearch.class.getResource( "search.resources.reduce.js" ).getFile() );
    ...
    public FeatureSearch generate() throws IOException {
